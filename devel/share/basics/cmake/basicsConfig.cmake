...
if("TRUE" STREQUAL "TRUE")
  set(basics_SOURCE_PREFIX /home/yuchen/catkin_ws/src/basics)
  set(basics_DEVEL_PREFIX /home/yuchen/catkin_ws/devel)
  set(basics_INSTALL_PREFIX "")
  set(basics_PREFIX ${basics_DEVEL_PREFIX})
else()
  set(basics_SOURCE_PREFIX "")
  set(basics_DEVEL_PREFIX "")
  set(basics_INSTALL_PREFIX /home/yuchen/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'yuchen <yuchen@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'basics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yuchen/catkin_ws/src/basics/${idir}'.  Ask the maintainer 'yuchen <yuchen@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yuchen/catkin_ws/devel/lib;/home/yuchen/catkin_ws/devel/lib;/opt/ros/indigo/lib)
